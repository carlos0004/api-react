...
const CreateAutor = () => {
    ...
    const onSubmit = async (data) => {
        ...
        if (!response.error) {
            navigate("/autores");
            toast.success("Autor creado con exito", {
                position: "top-center",
            });
        } else {
            ...
            <div className="max-w-2xl mx-auto p-6">
                <form onSubmit={handleSubmit(onSubmit)} className="bg-white shadow-md rounded-2xl px-8 pt-6 pb-8 mb-4">
                    <div className="mb-4">
                        ...
                        <input {...register("nombre", { required: "El nombre del autor es obligatorio" })} className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="nombre" type="text" placeholder="Nombre del Autor" />
